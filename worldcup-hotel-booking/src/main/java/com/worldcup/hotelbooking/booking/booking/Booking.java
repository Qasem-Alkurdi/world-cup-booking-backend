...
public class Booking {
    ...
    Booking(int matchId, LocalDate checkInDate, LocalDate checkOutDate, int numberOfGuests, int numberOfAdults, int numberOfChildren, BigDecimal totalPrice, String status, AppUser user, Hotel hotel) {
