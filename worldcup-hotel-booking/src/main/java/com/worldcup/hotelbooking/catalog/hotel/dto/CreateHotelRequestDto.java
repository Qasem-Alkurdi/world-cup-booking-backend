...
/**
 * @param ownerId مؤقت للتست
 */
@AllArgsConstructor
public record CreateHotelRequestDto(@NotNull Long ownerId, @NotBlank String name, String description,
                                    @Email String contactEmail, String contactPhone, @NotBlank String country,
                                    @NotBlank String city, String addressLine, @NotNull Double latitude,
                                    @NotNull Double longitude, Boolean hasWifi, Boolean hasParking,
