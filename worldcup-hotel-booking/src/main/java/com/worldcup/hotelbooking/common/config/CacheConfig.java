...
public class CacheConfig {
    ...
    public static class CacheTtlProperties {
        ...
        public int getHotelById()          { return hotelById; }
        public void setHotelById(int v)    { hotelById = v; }

        public int getMyHotels()           { return myHotels; }
        public void setMyHotels(int v)     { myHotels = v; }

        public int getHotelPhotos()        { return hotelPhotos; }
        public void setHotelPhotos(int v)  { hotelPhotos = v; }

        public int getRoomTypesByHotel()         { return roomTypesByHotel; }
        public void setRoomTypesByHotel(int v)   { roomTypesByHotel = v; }

        public int getRoomTypeById()             { return roomTypeById; }
        public void setRoomTypeById(int v)       { roomTypeById = v; }

        public int getRoomTypePhotos()           { return roomTypePhotos; }
        public void setRoomTypePhotos(int v)     { roomTypePhotos = v; }

        public int getBookingById()              { return bookingById; }
        public void setBookingById(int v)        { bookingById = v; }

        public int getBookingByReference()       { return bookingByReference; }
        public void setBookingByReference(int v) { bookingByReference = v; }

        public int getGuestHistory()             { return guestHistory; }
        public void setGuestHistory(int v)       { guestHistory = v; }
